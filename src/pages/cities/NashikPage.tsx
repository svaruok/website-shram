...
const services = [
  'Electricians in Nashik', 'Plumbers in Nashik', 'Masons in Nashik',
  'Carpenters in Nashik', 'Painters in Nashik', 'Cleaners in Nashik',
  'Drivers in Nashik', 'Helpers in Nashik',
];

const areas = ['Gangapur Road', 'College Road', 'Nashik Road', 'Dwarka', 'Ambad', 'Cidco', 'Satpur', 'Deolali'];
...
export default function NashikPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Hire Verified Workers in Nashik — Electrician, Plumber, Mason | Shramico</title>
        <meta name="description" content="Find verified electricians, plumbers, masons, carpenters and skilled workers in Nashik. Shramico connects Nashik employers with background-checked, rated professionals." />
        <meta name="keywords" content="electrician in Nashik, plumber in Nashik, mason in Nashik, hire workers Nashik, skilled workers Nashik, Shramico Nashik" />
        <script type="application/ld+json">{JSON.stringify({
          "@context": "https://schema.org",
          "@type": "LocalBusiness",
          "name": "Shramico — Hire Workers in Nashik",
          "description": "Hire verified electricians, plumbers, masons, and skilled workers in Nashik through the Shramico app.",
          "url": "https://shramico.com/workers-nashik",
      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-[#800020] to-[#5C0014] relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-white/60 bg-white/10 px-4 py-2 rounded-full border border-white/20 mb-6">
            <MapPin size={12} /> Nashik, Maharashtra
          </div>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white tracking-tight mb-6 leading-tight max-w-3xl">
            Hire Verified Workers in Nashik — Instantly
          </h1>
          <p className="text-white/70 text-lg max-w-2xl leading-relaxed mb-10">
            Find trusted electricians, plumbers, masons, carpenters and more in Nashik. All workers on Shramico are ID-verified, rated, and ready to work near you.
          </p>
          <a
            href={getAppLink() || '#'}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-black text-gray-900 mb-3">Workers Available in Nashik</h2>
          <p className="text-gray-500 mb-10">Browse by category — all verified and reviewed by real customers in Nashik</p>
      ...
      <section className="py-16 bg-gray-50 border-t border-gray-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-black text-gray-900 mb-6 flex items-center gap-2">
            <MapPin size={20} className="text-burgundy" /> Areas We Serve in Nashik
          </h2>
      ...
      <section className="py-20 bg-[#800020]">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-black text-white mb-4">Find workers in Nashik today</h2>
