...
export default function ColosseumPhilosophy() {
  ...
  // Track scroll progress purely over this specific section
  ...
  return (
    <section ref={containerRef} className="relative py-24 sm:py-32 bg-[#0a050e] overflow-hidden border-t border-white/5 min-h-[120vh]">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-40 mix-blend-screen">
        <Suspense fallback={null}>
          ...
          >
            <CollosseumScene scrollProgress={scrollYProgress} isMobile={false} />
          </Canvas>
        </Suspense>
      </div>
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#0a050e] via-transparent to-[#0a050e] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-6 text-white/60 text-lg leading-relaxed">
              ...
              <p>
                That is why every download of our app rebuilds the Colosseum. As you scroll through this section, watch the foundation rise—a symbol that together, worker by worker, we are building a monumental and trusted workforce ecosystem.
              </p>
            </div>
          </div>
